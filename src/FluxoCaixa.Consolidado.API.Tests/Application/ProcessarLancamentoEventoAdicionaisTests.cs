...
public class ProcessarLancamentoEventoAdicionaisTests
{
    ...
    public ProcessarLancamentoEventoAdicionaisTests()
    {
    ...
    public async Task ProcessarCriado_MultiplosEventosMesmoDia_DeveCriarConsolidadoUmaSoVez()
    {
        ...
        {
            Id = Guid.NewGuid(), Data = data, Valor = 100m,
            Tipo = TipoLancamento.Credito, Descricao = "Primeiro"
        });
        ...
        await _useCase.ProcessarCriadoAsync(new LancamentoCriadoEvent
        {
            Id = Guid.NewGuid(), Data = data, Valor = 200m,
            Tipo = TipoLancamento.Credito, Descricao = "Segundo"
        });
    ...
    public async Task ProcessarCriado_SempreInvalidaCacheAposGravar()
    {
        ...
        await _useCase.ProcessarCriadoAsync(new LancamentoCriadoEvent
        {
            Id = Guid.NewGuid(), Data = data,
            Valor = 100m, Tipo = TipoLancamento.Debito, Descricao = "Teste"
        });
